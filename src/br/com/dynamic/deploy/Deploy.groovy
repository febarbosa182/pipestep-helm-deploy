                ...
                jenkins.container('helm'){
                    ...
                    jenkins.withKubeConfig([
                        ...
                        jenkins.sh label: 'Deploy on minikube 🚀', script:"""
                            ...
                            helm upgrade --install --kubeconfig=\${KUBECONFIG} --kube-apiserver='https://kubernetes.default.svc/api' --namespace=\${KUBE_NAMESPACE} \${HELM_RELEASE_NAME} --set-string image.tag=\${APP_VERSION}.\${GIT_COMMIT} ./\${HELM_CHART_NAME}*.tgz
                        """
                    }
